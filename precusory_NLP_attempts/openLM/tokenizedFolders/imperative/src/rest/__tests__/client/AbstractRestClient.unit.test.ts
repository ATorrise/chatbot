 ...
 * / 
  ...
  * extends AbstractRestClient to use as a _ _ model _ _ . 
  * / 
         ...
         try { 
             await RestClient.getExpectString ( 
                 new Session ( { 
                     ...
                     basePath : " baseURL " , 
                     type : " cert - pem " , 
                     cert : join(__dirname , " .. " , " .. " , " .. " , " .. " , " _ _ tests _ _ " , " _ _ integration _ _ " , 
                         " cmd " , " _ _ tests _ _ " , " integration " , " cli " , " auth " , " _ _ resources _ _ " , " fakeCert.cert " ) , 
                     certKey : join(__dirname , " .. " , " .. " , " .. " , " .. " , " _ _ tests _ _ " , " _ _ integration _ _ " , 
                         " cmd " , " _ _ tests _ _ " , " integration " , " cli " , " auth " , " _ _ resources _ _ " , " fakeKey.key " ) , 
                 } ) , 
                 " /resource " ) ; 
         } catch ( thrownError ) { 
             error = thrownError ; 
