 ...
 * / 
 ...
 // * * NOTE :* * DefaultCredentialManager is mocked in such a way that the constructor parameters do n't matter here . 
     ...
     describe("Credential Manager functionality " , ( ) = > { 
         ...
         describe("Save operation " , ( ) = > { 
             it("should save credentials and store a profile with a constant string value for secure properties " , async ( ) = > { 
                 ...
                 // writtenProfile = = = undefined since BasicProfileManager gets mocked and does n't call ProfileIO.writeProfile 
