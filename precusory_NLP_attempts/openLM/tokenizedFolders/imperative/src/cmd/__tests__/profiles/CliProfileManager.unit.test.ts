 ...
 * / 
 ...
 describe("Cli Profile Manager " , ( ) = > { 
     ...
     const addTwoNumbersHandler = _ _ dirname + " /profileHandlers / AddTwoNumbersHandler " ; 
     const doNothingHandler = _ _ dirname + " /profileHandlers / DoNothingHandler " ; 
     const throwErrorHandler = _ _ dirname + " /profileHandlers / ThrowErrorHandler " ; 
     ...
     it("If we provide a non existent handler to create a profile from command line arguments , " + 
         ...
         configs[0].createProfileFromArgumentsHandler = _ _ dirname + " /profileHandlers / fakearooni " ; 
         const manager = new CliProfileManager ( { 
             profileRootDirectory : profileDir , 
             type : profileTypeOne , 
             logger : testLogger , 
     ...
     it("If we provide a non existent handler to update a profile from command line arguments , " + 
         ...
         configs[0].updateProfileFromArgumentsHandler = _ _ dirname + " /profileHandlers / fakearooni " ; 
         const manager = new CliProfileManager ( { 
             profileRootDirectory : profileDir , 
             type : profileTypeOne , 
             logger : testLogger , 
