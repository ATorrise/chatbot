 ...
 * / 
 ...
 describe("WebHelpGenerator " , ( ) = > { 
     describe("buildHelp " , ( ) = > { 
         ...
         beforeAll(async ( ) = > { 
             ...
             " Excepteur sint occaecat cupidatat non proident , sunt in culpa qui officia deserunt mollit anim i d est laborum . " ; 
         ...
         it("should create Help files " , async ( ) = > { 
             ...
             fileNmToTest = webHelpDocsDirNm + " / " + moduleFileNm + " _ hello.html " ; 
             fileText = fs.readFileSync(fileNmToTest , " utf8 " ) ; 
             expect(fileText).toContain("<h4 > Commands</h4 > " ) ; 
             expect(fileText).toContain("<h4 > Groups</h4 > " ) ; 

             fileNmToTest = webHelpDocsDirNm + " / " + moduleFileNm + " _ hello_wordWrap.html " ; 
             fileText = fs.readFileSync(fileNmToTest , " utf8 " ) ; 
 ...
 ` ) ; 
             ...
             fileNmToTest = webHelpDocsDirNm + " / " + moduleFileNm + " _ hello_linkify.html " ; 
             fileText = fs.readFileSync(fileNmToTest , " utf8 " ) ; 
             expect(fileText).toContain("<h4 > Usage</h4 > " ) ; 
             ...
             expect(existsSync(webHelpDocsDirNm + " / " + moduleFileNm + " _ config.html")).toBe(true ) ; 
             expect(existsSync(webHelpDocsDirNm + " / " + moduleFileNm + " _ hello_wordWrap.html")).toBe(true ) ; 
             expect(existsSync(webHelpDocsDirNm + " / " + moduleFileNm + " _ hello_universe.html")).toBe(true ) ; 
             expect(existsSync(webHelpDocsDirNm + " / " + moduleFileNm + " _ hello_world.html")).toBe(true ) ; 
             expect(existsSync(webHelpDocsDirNm + " / " + moduleFileNm + " _ plugins_install.html")).toBe(true ) ; 
             expect(existsSync(webHelpDocsDirNm + " / " + moduleFileNm + " _ plugins_uninstall.html")).toBe(true ) ; 
         } ) ; 
     } ) ; 
 } ) ; 
