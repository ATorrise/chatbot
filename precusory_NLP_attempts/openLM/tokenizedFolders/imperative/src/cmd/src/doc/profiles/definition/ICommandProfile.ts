 ...
 * / 
 ...
 export interface ICommandProfile { 
      ...
      * If a profile of a required type can not be found , the command will fail . 
      * @type { string [ ] } 
      ...
      * Imperative will automatically attempt to load ( the default OR the profile specified by name on the CLI ) . 
      * If a profile of an optional type can not be found , the command can still continue . It is the responsiblity of the 
