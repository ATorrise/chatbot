 ...
 * / 
 ...
 export interface ICommandProfileTypeConfiguration extends IProfileTypeConfiguration { 
      ...
      * 
      * 
      * This is only required if finished profile ca n't be created directly from the arguments , e.g. 
      ...
      * the final profile object that you would like to be written . 
      * 
      * This is only required if finished updated profile ca n't be created directly from the arguments , e.g. 
