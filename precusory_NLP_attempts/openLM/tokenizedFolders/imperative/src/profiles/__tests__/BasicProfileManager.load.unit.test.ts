 ...
 * / 
 ...
 describe("Basic Profile Manager Load " , ( ) = > { 
     ...
     it("should fail if the default does n't exist " , async ( ) = > { 
         const prof = new BasicProfileManager ( { 
             profileRootDirectory : TEST_PROFILE_ROOT_DIR , 
     ...
     it("should not allow us to load a profile with an optional dependency and the optional dependency does n't exist " , async ( ) = > { 
         const prof = new BasicProfileManager ( { 
             profileRootDirectory : TEST_PROFILE_ROOT_DIR , 
             typeConfigurations : STRAWBERRY_WITH_OPTIONAL_APPLE_DEPENDENCY , 
             type : STRAWBERRY_PROFILE_TYPE , 
     ...
     it("should allow us to load a profile where an optional dependency does n't exist ( but fail not found is false ) " , async ( ) = > { 
         const prof = new BasicProfileManager ( { 
             profileRootDirectory : TEST_PROFILE_ROOT_DIR , 
             typeConfigurations : STRAWBERRY_WITH_OPTIONAL_APPLE_DEPENDENCY , 
             type : STRAWBERRY_PROFILE_TYPE , 
     ...
     it("should fail a load if the profile does n't have the required dependencies listed when loaded " , async ( ) = > { 
         const prof = new BasicProfileManager ( { 
             profileRootDirectory : TEST_PROFILE_ROOT_DIR , 
             typeConfigurations : STRAWBERRY_WITH_REQUIRED_APPLE_DEPENDENCY , 
             type : STRAWBERRY_PROFILE_TYPE , 
