 ...
 * / 
 ...
 export class TextUtils { 
      ...
      *   ( but do n't try to use both ! ) and format the string accordingly 
     ...
     public static parseKeyValueString(keysAndValues : string ): { [ key : string ] : string } { 
         ...
         const keyValueEntrySplitKey = " _ SPLIT_ENTRY _ " ; 
         const valueSplitKey = " _ SPLIT_KEY _ " ; 
