 ...
 export class CliUtils { 
     ...
     public static getOptValueFromProfiles(profiles : CommandProfiles , definitions : ICommandProfile , 
         ...
         profileOrder.forEach((profileType : string ) = > { 
             ...
             // Get the first profile loaded - for now , we wo n't worry about profiles and double - type loading for dependencies 
     ...
     public static async promptWithTimeout ( 
         ...
         if ( hideText ) { 
             ttyIo._writeToOutput = function _ writeToOutput(stringToWrite : string ) { 
