 ...
 describe("ConfigAutoStore tests " , ( ) = > { 
     beforeAll ( ( ) = > { 
         const baseProfileConfig : any = { 
             ...
             authConfig : [ 
                 { 
                     handler : _ _ dirname + " / .. / .. /imperative / src / auth/__tests__/__data__/FakeAuthHandler " 
                 } 
             ] , 
             schema : { 
                 properties : { 
     ...
     describe("storeSessCfgProps " , ( ) = > { 
         ...
         beforeEach ( ( ) = > { 
             findActiveProfileSpy = jest.spyOn(ConfigAutoStore as any , " _ findActiveProfile " ) ; 
         } ) ; 
     ...
     describe("fetchTokenForSessCfg " , ( ) = > { 
         it("should fetch token when auth handler is found " , async ( ) = > { 
             ...
             jest.spyOn(ConfigAutoStore as any , " _ findAuthHandlerForProfile").mockReturnValueOnce ( { 
                 getAuthHandlerApi : ( ) = > ( { 
         ...
         it("should do nothing when auth handler is not found " , async ( ) = > { 
             jest.spyOn(ConfigAutoStore as any , " _ findAuthHandlerForProfile").mockReturnValueOnce(undefined ) ; 
