 ...
 * / 
 ...
 describe("Old - school ProfileInfo tests " , ( ) = > { 
     ...
     const homeDirPath = path.join(testDir , testAppNm + " _ home " ) ; 
     const homeDirPathTwo = path.join(testDir , testAppNm + " _ home_two " ) ; 
     const homeDirPathThree = path.join(testDir , testAppNm + " _ home_three " ) ; 
     const four = 4 ; 
     let origDir : string ; 
     ...
     beforeEach ( ( ) = > { 
         ...
         process.env[testEnvPrefix + " _ CLI_HOME " ] = homeDirPath ; 
     } ) ; 
     ...
     describe("getDefaultProfile " , ( ) = > { 
         ...
         it("should return null if no default for that type exists 2 " , async ( ) = > { 
             process.env[testEnvPrefix + " _ CLI_HOME " ] = homeDirPathTwo ; 
         ...
         it("should return null if no default for that type exists 3 " , async ( ) = > { 
             process.env[testEnvPrefix + " _ CLI_HOME " ] = homeDirPathThree ; 
         ...
         it("should return null if profile root dir does not exist " , async ( ) = > { 
             const invalidHomeDir = homeDirPath + " _ does_not_exist " ; 
             process.env[testEnvPrefix + " _ CLI_HOME " ] = invalidHomeDir ; 
