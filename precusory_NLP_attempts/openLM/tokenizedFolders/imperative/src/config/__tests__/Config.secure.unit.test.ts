 ...
 * / 
 ...
 const projectConfigPath = path.join(__dirname , " _ _ resources__/project.config.json " ) ; 
 const projectUserConfigPath = path.join(__dirname , " _ _ resources__/project.config.user.json " ) ; 
