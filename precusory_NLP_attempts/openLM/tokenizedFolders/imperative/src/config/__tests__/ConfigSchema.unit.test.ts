 ...
 describe("Config Schema " , ( ) = > { 
     ...
     describe("Function : updateSchema " , ( ) = > { 
         ...
         it("should update the schema without any parameters " , ( ) = > { 
             const mySpy = jest.spyOn((ConfigSchema as any ) , " _ updateSchemaActive").mockReturnValue(fakeUpdatesPaths_active ) ; 
         ...
         it("should update the schema with a given schema and layer " , ( ) = > { 
             const mySpy = jest.spyOn((ConfigSchema as any ) , " _ updateSchemaGlobal").mockReturnValue(fakeUpdatesPaths_active ) ; 
         ...
         it("should update the schema with a given schema , layer , and depth " , ( ) = > { 
             const mySpy = jest.spyOn((ConfigSchema as any ) , " _ updateSchemaAll").mockReturnValue(fakeUpdatesPaths_active ) ; 
         ...
         describe("Helper : _ Global " , ( ) = > { 
             it("should update the schema by relying on the _ Active helper function " , ( ) = > { 
                 const mySpy = jest.spyOn((ConfigSchema as any ) , " _ updateSchemaActive").mockReturnValue(fakeUpdatesPaths_active ) ; 
         ...
         describe("Helper : _ All " , ( ) = > { 
             it("should update only the global layer if no other layers were found in the directory structure " , ( ) = > { 
                 ...
                 const spyActive = jest.spyOn((ConfigSchema as any ) , " _ updateSchemaActive").mockReturnValue(fakeUpdatesPaths_active ) ; 
                 const spyGlobal = jest.spyOn((ConfigSchema as any ) , " _ updateSchemaGlobal").mockReturnValue(fakeUpdatesPaths_global ) ; 
             ...
             it("should update all schemas found up the directory structure and down to the given depth " , ( ) = > { 
                 ...
                 const spyActive = jest.spyOn((ConfigSchema as any ) , " _ updateSchemaActive " ) 
