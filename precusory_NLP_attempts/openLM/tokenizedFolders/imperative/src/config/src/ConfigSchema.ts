 ...
 * / 
 ...
 export class ConfigSchema { 
      ...
      * @param forceSetSchema Indicates if we should force the creation of the schema file even if the config does n't exist ( e.g. config init ) 
      ...
      * / 
     private static _ updateSchemaActive ( 
      ...
      * @returns Object containing the updated schema paths 
      * / 
     private static _ updateSchemaGlobal(opts : IConfigUpdateSchemaHelperOptions ): IConfigUpdateSchemaPaths { 
         let updatedPaths : IConfigUpdateSchemaPaths = opts.updatedPaths ; 
      ...
      * @returns Object containing the updated schema paths 
      * / 
     private static _ updateSchemaAll(opts : IConfigUpdateSchemaHelperOptions ): IConfigUpdateSchemaPaths { 
     ...
     public static updateSchema(options ? : IConfigUpdateSchemaOptions ): IConfigUpdateSchemaPaths { 
         ...
         const _ updateSchemaOptions : IConfigUpdateSchemaHelperOptions = { config , layer , updatedPaths , updateOptions : opts } ; 

         // Operate based on the given layer 
         switch ( opts.layer ) { 
             case " active " : { 
                 // Call the _ updateSchemaActive helper function 
                 updatedPaths = { ... updatedPaths , ... this._updateSchemaActive(_updateSchemaOptions , typeof options = = = " undefined " ) } ; 
                 break ; 
             } 
             case " global " : { 
                 // Call the _ updateSchemaGlobal helper function 
                 updatedPaths = { ... updatedPaths , ... this._updateSchemaGlobal(_updateSchemaOptions ) } ; 
                 break ; 
             } 
             case " all " : { 
                 // Call the _ updateSchemaAll helper function 
