 ...
 * / 
 ...
 export class ConfigAutoStore { 
      ...
      * @returns Tuple containing profile type and name , or undefined if no profile was found 
      * / 
     private static _ findActiveProfile(opts : IConfigAutoStoreFindActiveProfileOpts ): [ string , string ] | undefined { 
      ...
      * @returns Auth handler class or undefined if none was found 
      * / 
     private static _ findAuthHandlerForProfile(opts : IConfigAutoStoreFindAuthHandlerForProfileOpts ): AbstractAuthHandler | undefined { 
      ...
      * / 
     public static async _ storeSessCfgProps(opts : IConfigAutoStoreStoreSessCfgPropsOpts ): Promise < void > { 
         const config = opts.config || ImperativeConfig.instance.config ; 
      ...
      * @returns True if auth handler was found and token was fetched 
      * / 
     private static async _ fetchTokenForSessCfg(opts : IConfigAutoStoreStoreSessCfgPropsOpts ): Promise < boolean > { 
