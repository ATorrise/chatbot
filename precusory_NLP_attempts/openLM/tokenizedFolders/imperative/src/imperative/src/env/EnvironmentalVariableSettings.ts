 ...
 * / 
 ...
 export class EnvironmentalVariableSettings { 
      ...
      * / 
     public static readonly IMPERATIVE_LOG_LEVEL_KEY_SUFFIX = " _ IMPERATIVE_LOG_LEVEL " ; 
      ...
      * @memberof EnvironmentalVariableSettings 
      * / 
     public static readonly APP_LOG_LEVEL_KEY_SUFFIX = " _ APP_LOG_LEVEL " ; 
      ...
      * @memberof EnvironmentalVariableSettings 
      * / 
     public static readonly APP_MASK_OUTPUT_SUFFIX = " _ APP_MASK_OUTPUT " ; 
      ...
      * @memberof EnvironmentalVariableSettings 
      * / 
     public static readonly CLI_HOME_SUFFIX = " _ CLI_HOME " ; 
      ...
      * @memberof EnvironmentalVariableSettings 
      * / 
     public static readonly PROMPT_PHRASE_SUFFIX = " _ PROMPT_PHRASE " ; 
      ...
      * @memberof EnvironmentalVariableSettings 
      * / 
     public static readonly CLI_PLUGINS_DIR_SUFFIX = " _ CLI_PLUGINS_DIR " ; 
