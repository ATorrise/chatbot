 ...
 * / 
 ...
 export interface IGetItemVal { 
     itemVal : string ;         // Value of the item . Null when we can not get the value . 
 ...
 export class EnvQuery { 
     private static readonly divider = ` _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ $ { os . EOL } ` ; 
     ...
     private static getOtherZoweEnvVars(getResult : IGetItemVal ): void { 
         ...
         for ( const nextVar of Object.keys(envVars ) ) { 
             if ( nextVar.startsWith("ZOWE _ " ) & & nextVar ! = " ZOWE_CLI_HOME " & & 
         ...
         if ( getResult.itemValMsg.length = = 0 ) { 
             getResult.itemValMsg + = " No other ' ZOWE _ ' variables have been set . " ; 
         } 
     } 
