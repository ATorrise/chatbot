 ...
 * / 
 ...
 export default class ConvertProfilesHandler implements ICommandHandler { 
     ...
     public async process(params : IHandlerParameters ): Promise < void > { 
         ...
         // Can not do profiles operations w/ team config 
         ...
         if ( configExists ) { 
             ...
             params.response.console.log(`A team configuration file was detected . V1 profiles can not be loaded for conversion.\n ` + 
      ...
      * ` Object.freeze ` so can not be modified later on . 
      * / 
