 ...
 * / 
 ...
 describe("BaseAuthHandler config " , ( ) = > { 
     ...
     describe("login " , ( ) = > { 
         const configPath = _ _ dirname + ` /__resources__/no_auth.config.json ` ; 
         const fakeVault = { 
             load : jest.fn ( ) , 
             save : jest.fn ( ) 
         } ; 
         ...
         describe("default layer " , ( ) = > { 
             ...
             it("should update existing base profile if it does n't contain user / password " , async ( ) = > { 
                 const handler = new FakeAuthHandler ( ) ; 
                 const params = lodash.cloneDeep(loginParams ) ; 
     ...
     describe("logout " , ( ) = > { 
         const configPath = _ _ dirname + ` /__resources__/auth.config.json ` ; 
         const fakeVault = { 
