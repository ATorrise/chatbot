 ...
 export abstract class BaseAuthHandler extends AbstractAuthHandler { 
     ...
     protected async processLogout(params : IHandlerParameters ) { 
         ...
         if ( ! ImperativeConfig.instance.config.exists ) { 
             ...
             let noDeleteReason = " " ; 
             // If you specified a token on the command line , then do n't delete the one in the profile if it does n't match 
             ...
             if ( params.arguments.tokenValue ! = null ) { 
                 ...
                 params.response.console.error("Token was not provided , so ca n't log out . "+ 
