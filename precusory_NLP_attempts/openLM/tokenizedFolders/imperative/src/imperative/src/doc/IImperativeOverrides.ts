 ...
 * / 
 ...
 interface ImperativeOverrides extends IOverridesRestriction { 
      ...
      * those cases where you want to have a bit more control by using ` _ _ dirname ` ) or a relative path . 
      * 
      * In the case that the string is a relative path , it _ _ MUST _ _ be a path relative to the entry 
      * point of your CLI . ( _ _ NOTE : _ _ In the case of a plugin , this is relative to your require entry point ) 
      * 
      * For example : 
      * 
      * _ _ Assume _ _ 
      ...
      * 
      * _ Exporting an Anonymous Class _ 
      * ` ` ` TypeScript 
      ...
      * ` ` ` 
      * 
      * _ Using ` module.exports ` ( Not preferred for TypeScript Users ) _ 
      * ` ` ` TypeScript 
