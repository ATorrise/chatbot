 ...
 * / 
 ...
 export class ProfilesUpdateCommandBuilder extends ProfilesCommandBuilder { 
     ...
     protected buildProfileSegmentFromSchema ( ): ICommandDefinition { 
         ...
         // clone the properties file before trying to modify them so that we do n't affect the original 
         ...
         const profileCommand : ICommandDefinition = { 
             ...
             type : " command " , 
             handler : _ _ dirname + " / .. /handlers / UpdateProfilesHandler " , 
         ...
         // We do n't want to override existing settings with defaultValue for an option 
