 ...
 * / 
  ...
  *                           so if calling functions do n't have a registry available , they need 
  *                           to get it from npm . 
  * 
 ...
 export async function install(packageLocation : string , registry : string , installFromFile = false ) { 
     ...
     // Do some parsing on the package location in the case it is n't an absolute location 
     // If 
     ...
     //    to an absolute file path . If we ca n't resolve it locally , we 'll leave it up to npm 
     //    to do what 's best . 
     if ( 
         ! installFromFile & & 
     ...
     try { 
         ...
         { 
             ...
             // This might be needed outside of PLUGIN_USING_CONFIG scenarios , but we have n't had issues with other APIs before 
