 ...
 * / 
 ...
 const loginDescription = 
     ...
     " If you used this flag once for specific registry , you do n't have to use it again , it uses credentials from .npmrc file.\n " + 
     " \n " + 
     " For more information about npm registries , see : \n " + 
 ...
 export const updateDefinition : ICommandDefinition = { 
     ...
     examples : [ 
       ...
       " ( do n't need to use this flag if you have already logged in before ) " , 
