 ...
 describe("Configuration Import command handler " , ( ) = > { 
     ...
     describe("handler " , ( ) = > { 
         ...
         it("should import config from local file " , async ( ) = > { 
             ...
             params.arguments.location = _ _ dirname + " /fakeapp.config.json " ; 
     ...
     describe("download schema " , ( ) = > { 
         const schemaSrcPath = _ _ dirname + " /fakeapp.schema1.json " ; 
         const schemaDestPath = _ _ dirname + " /fakeapp.schema2.json " ; 
