 ...
 * / 
 ...
 describe("DefinitionTreeResolver tests " , ( ) = > { 
     ...
     it("should match on glob with dummy handler " , ( ) = > { 
         const def = DefinitionTreeResolver.resolve ( " " , " " , _ _ dirname , new Logger(new Console ( ) ) , [ ] , [ " * * /*.definition!(.d).*s " ] ) ; 
     ...
     it("should match on definition with dummy handler " , ( ) = > { 
         const def = DefinitionTreeResolver.resolve ( " " , " " , _ _ dirname , new Logger(new Console ( ) ) , [ fakeDefinition ] , [ ] ) ; 
         expect(def.children).toBeDefined ( ) ; 
         expect(def.children.length).toBe(1 ) ; 
         expect(def.children[0].profile).toBeDefined ( ) ; 
         expect(def.children[0].profile.required).toEqual(["sample " ] ) ; 
     ...
     it("should match on glob with dummy handler with null child definitions " , ( ) = > { 
         const def = DefinitionTreeResolver.resolve ( " " , " " , _ _ dirname , new Logger(new Console ( ) ) , null as any , [ " * * /*.definition!(.d).*s " ] ) ; 
         expect(def.children).toBeDefined ( ) ; 
         expect(def.children.length).toBe(1 ) ; 
         expect(def.children[0].profile).toBeDefined ( ) ; 
         expect(def.children[0].profile.required).toEqual(["sample " ] ) ; 
     ...
     it("should match on glob with dummy handler with undefined child definitions " , ( ) = > { 
         const def = DefinitionTreeResolver.resolve ( " " , " " , _ _ dirname , new Logger(new Console ( ) ) , undefined , [ " * * /*.definition!(.d).*s " ] ) ; 
         expect(def.children).toBeDefined ( ) ; 
         expect(def.children.length).toBe(1 ) ; 
         expect(def.children[0].profile).toBeDefined ( ) ; 
         expect(def.children[0].profile.required).toEqual(["sample " ] ) ; 
     ...
     it("should match on child definition with undefined glob " , ( ) = > { 
         const def = DefinitionTreeResolver.resolve ( " " , " " , _ _ dirname , new Logger(new Console ( ) ) , [ fakeDefinition ] , undefined ) ; 
         expect(def.children).toBeDefined ( ) ; 
         expect(def.children.length).toBe(1 ) ; 
         expect(def.children[0].profile).toBeDefined ( ) ; 
         expect(def.children[0].profile.required).toEqual(["sample " ] ) ; 
     ...
     it("should match on child definition with null glob " , ( ) = > { 
         const def = DefinitionTreeResolver.resolve ( " " , " " , _ _ dirname , new Logger(new Console ( ) ) , [ fakeDefinition ] , null as any ) ; 
         expect(def.children).toBeDefined ( ) ; 
         expect(def.children.length).toBe(1 ) ; 
         expect(def.children[0].profile).toBeDefined ( ) ; 
         expect(def.children[0].profile.required).toEqual(["sample " ] ) ; 
     ...
     it("should match on glob with dummy handler and add base profile " , ( ) = > { 
         const def = DefinitionTreeResolver.resolve ( " " , " " , _ _ dirname , new Logger(new Console ( ) ) , [ ] , [ " * * /*.definition!(.d).*s " ] , true ) ; 
         expect(def.children).toBeDefined ( ) ; 
         expect(def.children.length).toBe(1 ) ; 
         expect(def.children[0].profile).toBeDefined ( ) ; 
         expect(def.children[0].profile.required).toEqual(["sample " ] ) ; 
