 ...
 * / 
 ...
 describe("PluginRequireProvider " , ( ) = > { 
      ...
      * / 
     const testRequireIndicator = " _ _ TEST_REQUIRE _ _ " ; 
      ...
      * while test requires do n't try to load anything . 
      * / 
     ...
     describe("environment stability " , ( ) = > { 
         ...
         it("should guard against destroying hooks that have n't been created " , ( ) = > { 
             expect ( ( ) = > { 
                 PluginRequireProvider.destroyPluginHooks ( ) ; 
     ...
     describe("injection tests " , ( ) = > { 
         ...
         describe("use proper regex format " , ( ) = > { 
             ...
             // We do n't need to worry about checking anything with a special character 
                     ...
                     describe("should redirect to an injected module " , ( ) = > { 
                         for ( const module of testData.modules ) { 
                             it(`passes with module " $ { module } " ` , ( ) = > { 
                                 ...
                                 // The host package ca n't match the module for the purpose of this test 
