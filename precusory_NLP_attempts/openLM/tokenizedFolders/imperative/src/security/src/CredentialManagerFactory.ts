 ...
 * / 
 ...
 export class CredentialManagerFactory { 
      ...
      * does n't extend the { @link AbstractCredentialManager } , this method will throw an error . 
      * 
      ...
      * in a JavaScript " Can not assign to read only property " exception because your class is immutable . 
     ...
     public static async initialize(params : ICredentialManagerInit ): Promise < void > { 
         ...
         try { 
             ...
             // instance of an abstract credential manager . Since we can not assume that our internal 
