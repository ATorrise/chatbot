 ...
 * / 
 ...
 export class DefaultCredentialManager extends AbstractCredentialManager { 
      ...
      * 
      * We do n't support older versions of Windows where the limit is 512 bytes . 
      * / 
     ...
     constructor(service : string , displayName : string = " default credential manager " ) { 
         ...
         // constructor does n't do anything . Who knows what things might happen in 
      ...
      * that the load does n't hold up the main class execution . 
      * 
