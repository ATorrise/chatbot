 ...
 * / 
 ...
 describe("CredentialManagerFactory " , ( ) = > { 
     ...
     describe("Credential manager provided by base cli " , ( ) = > { 
         it("should throw an error when the class does n't extend the AbstractCredentialManager " , async ( ) = > { 
     ...
     describe("Emulating a loaded plugin " , ( ) = > { 
         ...
         it("should handle being passed an object that is n't a class or string " , async ( ) = > { 
