     ...
     describe("censorRawData " , ( ) = > { 
         ...
         describe("should NOT censor " , ( ) = > { 
             ...
             describe("special value : " , ( ) = > { 
                 ...
                 const _ lazyTest = ( prop : string ): [ string , string ] = > { 
                 ...
                 it("user " , ( ) = > { 
                     const [ received , expected ] = _ lazyTest("user " ) ; 
                     expect(received).toEqual(expected ) ; 
                 } ) ; 
                 it("password " , ( ) = > { 
                     const [ received , expected ] = _ lazyTest("password " ) ; 
                     expect(received).toEqual(expected ) ; 
                 } ) ; 
                 it("tokenValue " , ( ) = > { 
                     const [ received , expected ] = _ lazyTest("tokenValue " ) ; 
                     expect(received).toEqual(expected ) ; 
                 } ) ; 
             } ) ; 
         } ) ; 
