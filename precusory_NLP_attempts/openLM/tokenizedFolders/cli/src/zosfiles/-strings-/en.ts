 ...
 export default { 
     ...
     CREATE : { 
             ...
             VSAM : { 
                 ...
                 OPTIONS : { 
                     ...
                     RETAINTO : " The earliest date that a command without the PURGE parameter can delete an entry . Specify the expiration " + 
                         ...
                         " retain - for nor retain - to is used . You can not specify both the ' retain - to ' and ' retain - for ' options . " , 
         ...
         OPTIONS : { 
             ...
             " differs from a partitioned data set ( PDS ) because it can not contain members , only file contents . " , 
         ...
         ACTIONS : { 
             ...
             DATA_SETS_MATCHING : { 
                 ...
                 POSITIONALS : { 
                     ...
                     However , the pattern can not begin with any of these sequences . You can specify multiple patterns separated by commas , ` + 
         ...
         ACTIONS : { 
             ...
             DIR_TO_USS : { 
                 ...
                 DESCRIPTION : " Upload a local directory to a USS directory.\n\n " + 
                     ...
                     " # Do n't upload the node_modules directory{{space}}{{space}}\n " + 
                     " node_modules      -{{space}}{{space}}\n " + 
                     " # Do n't upload files that start with periods{{space}}{{space}}\n " + 
                     " . *                -{{space}}{{space}}\n " + 
     ...
     COMPARE : { 
         ...
         ACTIONS : { 
             ...
             SPOOL_DD : { 
                 ...
                 POSITIONALS : { 
                     SPOOLDDDESCRIPTION1 : " The name of the first job with the i d of spool dd " , 
                     SPOOLDDDESCRIPTION2 : " The name of the second job with the i d of spool dd " 
                 } , 
                 EXAMPLES : { 
             ...
             LOCAL_FILE_SPOOL_DD : { 
                 ...
                 POSITIONALS : { 
                     LOCALFILEPATH : " The path of the local file   you want to compare . " , 
                     SPOOLDDDESCRIPTION : " The name of the job with the i d of spool dd " 
                 } , 
                 EXAMPLES : { 
