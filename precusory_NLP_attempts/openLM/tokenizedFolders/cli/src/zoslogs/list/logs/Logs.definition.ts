 ...
 * / 
 ...
 export const LogsDefinition : ICommandDefinition = { 
     ...
     type : " command " , 
     handler : _ _ dirname + " /Logs.handler " , 
     profile : { 
         optional : [ " zosmf " ] 
     } , 
     options : [ 
         ...
         { 
             ...
             ` of 's ' , ' m ' , ' h ' , for example , ' 999s ' , ' 20 m ' , ' 3h ' . ` , 
             type : " string " , 
             defaultValue : " 10 m " 
         } 
     ] , 
     examples : [ 
         { 
             ...
             options : " --start - time 2021 - 07 - 26T03:38:37.098Z --range 5 m --direction forward " 
         } , 
         { 
             ...
             options : " --st 2021 - 07 - 26T03:38:37.098Z -r 5 m -d forward " 
         } , 
         { 
             description : " List logs starting from ' 2021 - 07 - 26T03:38:37.098Z ' and backwards to 5 minutes before " , 
             options : " --start - time 2021 - 07 - 26T03:38:37.098Z --range 5 m " 
         } 
     ] 
 } ; 
