 ...
 * / 
 ...
 export class TsoConstants { 
     / * * 
      * Quert i d of logonProcedure passed to z / OSMF URI 
      * @static 
      * @type { string } 
     ...
     / * * 
      * Quert i d of character - set passed to z / OSMF URI 
      * @static 
      * @type { string } 
      * @memberof TsoConstants 
      * / 
     ...
     / * * 
      * Quert i d of code page passed to z / OSMF URI 
      * @static 
      * @type { string } 
      * @memberof TsoConstants 
      * / 
     ...
     / * * 
      * Quert i d of rows passed to z / OSMF URI 
      * @static 
      * @type { string } 
      * @memberof TsoConstants 
      * / 
     ...
     / * * 
      * Quert i d of columns passed to z / OSMF URI 
      * @static 
      * @type { string } 
      * @memberof TsoConstants 
      * / 
     ...
     / * * 
      * Quert i d of account number passed to z / OSMF URI 
      * @static 
      * @type { string } 
      * @memberof TsoConstants 
      * / 
     ...
     / * * 
      * Quert i d of region size passed to z / OSMF URI 
      * @static 
      * @type { string } 
      * @memberof TsoConstants 
      * / 
