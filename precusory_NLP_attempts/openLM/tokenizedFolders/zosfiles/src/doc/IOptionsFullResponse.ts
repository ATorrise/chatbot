 ...
 * / 
 ...
 export interface IOptionsFullResponse { 
      ...
      * when receiving data from the server to responseStream . Do n't set this for binary responses 
      * @type { boolean } 
      * @memberof IOptionsFullResponse 
      * / 
     ...
     / * * 
      * true if you want \r\n to be replaced with \n when sending 
      * data to the server from requestStream . Do n't set this for binary requests 
      * @type { boolean } 
      * @memberof IOptionsFullResponse 
      * / 
