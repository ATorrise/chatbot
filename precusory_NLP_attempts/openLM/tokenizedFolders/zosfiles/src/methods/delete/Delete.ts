 ...
 export class Delete { 
     ...
     public static async dataSet(session : AbstractSession , 
         ...
         try { 
             ...
             // Since there is a bug with the deleteExpectJSON ( does n't handle 204 no content ) we will be using the expect 
             // string api since that does n't seem to complain . 
